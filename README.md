...
**connpassでエントリーし、「参加番号」を発行してください。**
...
例えば、「うどん玉×1、大根おろし×1、肉×1、卵×1」で出荷した場合、おろしぶっかけ（320円）、肉うどん（450円）、肉釜玉うどん（550円）のいずれも成立しますが、
この場合、価格一覧表で最も下に位置している「肉釜玉うどん（550円）」が成立します。
